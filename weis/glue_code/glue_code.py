...
class WindPark(om.Group):
    ...
    def setup(self):
        ...
        tune_rosco_ivc.add_output('TCIPC_MaxPitchAmplitude', val=0.0, units='rad', desc='Maximum allowable pitch amplitude for TCIPC.')
        ...
        if modeling_options['ROSCO']['flag']:
            ...
            self.connect('tune_rosco_ivc.TCIPC_MaxPitchAmplitude', 'sse_tune.tune_rosco.TCIPC_MaxPitchAmplitude')
        ...
        if modeling_options['OpenFAST']['flag'] or modeling_options['OpenFAST_Linear']['flag']:
            ...
            if modeling_options['General']['openfast_configuration']['model_only'] == False:
                ...
                self.connect('tune_rosco_ivc.TCIPC_MaxPitchAmplitude', 'outputs_2_screen_weis.TCIPC_MaxPitchAmplitude')
