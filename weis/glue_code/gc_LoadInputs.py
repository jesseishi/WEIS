...
class WindTurbineOntologyPythonWEIS(WindTurbineOntologyPython):
    ...
    def update_ontology_control(self, wt_opt):
        ...
        if self.modeling_options['flags']['control']:
            ...
            self.wt_init['control']['TCIPC']['TCIPC_MaxPitchAmplitude'] = float(wt_opt['tune_rosco_ivc.TCIPC_MaxPitchAmplitude'])
            self.wt_init['control']['TCIPC']['TCIPC_nHarmonics'] = float(wt_opt['tune_rosco_ivc.TCIPC_nHarmonics'])
            self.wt_init['control']['TCIPC']['TCIPC_ZeroYawDeflection'] = float(wt_opt['tune_rosco_ivc.TCIPC_ZeroYawDeflection'])
