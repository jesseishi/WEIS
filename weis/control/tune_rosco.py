...
class TuneROSCO(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('TCIPC_MaxPitchAmplitude', val=0.0, units='rad', desc='Maximum allowable pitch amplitude for TCIPC')
    ...
    def compute(self,inputs,outputs, discrete_inputs, discrete_outputs):
        ...
        rosco_init_options['TCIPC_MaxPitchAmplitude'] = float(inputs['TCIPC_MaxPitchAmplitude'][0])
